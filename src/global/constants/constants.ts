export class Constants {
    ...
    public static STAGE_8_SPAWN_LABORERS_WHEN_CONTROLLER_BENEATH: number = 25_000;
    public static STAGE_8_SPAWN_UPGRADERS_WHEN_CONTROLLER_BENEATH: number = 50_000;
    //STAGES
    ...
    public static DONT_REPAIR_WITH_ALL_TOWERS_WHEN_BUCKET_UNDER: number = 1_000;
    ...
    public static LABORERS_NO_SPAWN: number = 4;
    ...
    //BUILDING HEALTH
    public static WALL_AND_RAMPART_GOAL_HEALTH_BELOW_STAGE_8: number = 500_000;
    public static WALL_AND_RAMPART_GOAL_HEALTH_STAGE_8: number = 2_000_000;
    public static CRITICAL_INFRASTRUCTURE_RAMPART_GOAL_HEALTH_STAGE_8: number = 10_500_000;
